...
![A 3rd-degree contact — the badge ring still appears but the trust score is lower](/images/guides/understanding-wot/trust-badge-3hop.jpg)

![3 hops, 1 shortest path, 15% trust score — thin connection with no path bonuses](/images/guides/understanding-wot/trust-tooltip-3hop.jpg)
