...
![Hovering the trust badge reveals the exact data — distance in hops, number of shortest paths, and the computed trust score](/images/guides/understanding-wot/trust-tooltip.jpg)
