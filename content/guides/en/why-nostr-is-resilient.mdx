...
![2025 cloud outages timeline — AWS, Cloudflare, and Azure all failed across the year, taking down X, ChatGPT, LinkedIn, and critical services with them](/images/guides/why-nostr-is-resilient/outage-timeline.svg)
