...
2026-09-24 14:00 UTC  published  nip-86-gains-seven-methods-and-takes-over-invites  (5 sources); second story today, after the 07:59 entry recovered a prepared Amethyst draft rather than surveying fresh merges. The NIP-86 cluster had never been evaluated: #2477 and #2481 merged after the 09-23 run, and #2408 was opened 2026-07-03 and merged 01:14 UTC today, so creation-date enumeration would have missed it. Reported from the diffs, not the PR bodies: #2477's description advertises clearpubkey, clearevent and listroles, none of which are in its merged diff.
2026-09-26 08:14 UTC  published  a-nostr-follow-list-is-a-complete-snapshot  (2 sources; evergreen fallback after #2483 was classified as a non-substantive event-kind table repair)
